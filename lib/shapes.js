...
function Triangle(baseTextInput, baseTextColor, baseShapeColor) {
    ...
    this.triangleStringHalf = "<polygon points=\"40 10, 260 10, 150 185\" style=\"fill: " + baseShapeColor + "\" />"
};
...
function setColor () {
    // should put inputted text into the "baseShapeColor" variable
};

function render() {
    console.log("halp");
    // return triangleStringHalf;
};

// exporting classes
module.exports = { Triangle, Circle, Square, setColor, render };