...
function Triangle(baseTextInput, baseTextColor, baseShapeColor, setColor) {
...
function Circle(baseTextInput, baseTextColor, baseShapeColor, setColor) {
    // calling from Shape class parent
    Shape.call(this, baseTextInput, baseTextColor, baseShapeColor);
    // string for the shape specific input into the svg file.
...
function Square(baseTextInput, baseTextColor, baseShapeColor, setColor) {
    // calling from Shape class parent
    Shape.call(this, baseTextInput, baseTextColor, baseShapeColor);
    // string for the shape specific input into the svg file.
